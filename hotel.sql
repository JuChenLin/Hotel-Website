...
-- room table (room_id, hotel_id, room_availability, room_feature, room_type, room_price)
insert into room values (1, 'ho000001', 'y', 'a economic room with a twin bed without kitchen', 'economic room', 75);
insert into room values (2, 'ho000001', 'y', 'a economic room with a full bed without kitchen', 'standard room', 100);
insert into room values (3, 'ho000001', 'y', 'a standard room with a full-size bed', 'one full room', 120);
insert into room values (4, 'ho000001', 'y', 'a standard room with a queen-size bed', 'one queen bed', 135);
insert into room values (5, 'ho000001', 'y', 'a standard room with a king-size bed', 'one king bed', 150);
insert into room values (6, 'ho000001', 'y', 'a standard room with two twim-size bed', 'two twin room', 130);
insert into room values (7, 'ho000001', 'y', 'a superior room with two full-size bed', 'two full room', 200);
insert into room values (8, 'ho000001', 'y', 'a superior room with two queen-size bed', 'two queen room', 240);
insert into room values (9, 'ho000001', 'y', 'a superior room with two king-size bed', 'two king room', 280);
insert into room values (10, 'ho000001', 'y', 'a superior room with three queen-size bed', 'triple room', 340);
insert into room values (11, 'ho000001', 'y', 'a luxury room with a king-size bed and a sofa bed', 'signature suite', 350);
insert into room values (12, 'ho000001', 'y', 'a luxury room with one california king-size bed, a sofa bed, and a jacuzzi', 'premium suite', 500);
insert into room values (13, 'ho000001', 'y', 'the room equiped with the most luxury living experience', 'presidential suite', 3000);
insert into room values (14, 'ho000001', 'y', 'a bigger space room allow a whole family up to ten people to spend their good time in a cozy space', 'family room', 800);
